...
#[Route('/comments', name: 'comment_submit', methods: ['POST'])]
...
final readonly class SubmitCommentController
{
    ...
    #[OA\Response(response: 413, description: 'Request body exceeds the admission limit.')]
    #[OA\Response(response: 429, description: 'Submission admission limit exceeded.')]
